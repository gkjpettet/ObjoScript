...
Protected Class GrammarRule
	#tag Method, Flags = &h0
		Sub Constructor(prefix As ObjoScript.PrefixParselet, infix As ObjoScript.InfixParselet, precedence As ObjoScript.Parser.Precedences)
		  Self.Prefix = prefix
		  Self.Infix = infix
	...
	#tag Property, Flags = &h0, Description = 54686520707265636564656E6365206F6620616E20696E6669782065787072657373696F6E2074686174207573657320746869732072756C65277320746F6B656E20617320616E206F70657261746F722E
		Precedence As ObjoScript.Parser.Precedences
	#tag EndProperty

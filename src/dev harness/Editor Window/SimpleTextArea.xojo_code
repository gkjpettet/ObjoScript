#tag Class
Protected Class SimpleTextArea
Inherits DesktopTextArea
	#tag Event
		Sub Opening()
		  // Disable smart quotes and smart dashes on macOS.
		  #If TargetCocoa Then
		    ...
		    myTextArea = documentView(Self.Handle)
		    ...
		    Declare Sub setAutomaticDashSubstitutionEnabled Lib "AppKit" Selector "setAutomaticDashSubstitutionEnabled:" _
		    (id As Ptr, value As Boolean)

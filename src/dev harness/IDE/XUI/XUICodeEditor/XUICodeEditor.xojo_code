...
Implements XUINotificationListener
	...
	#tag ComputedProperty, Flags = &h0, Description = 54686520666F726D6174746572207573656420746F20666F726D617420746578742E
		...
		#tag Setter
			Set
			  // This is to cripple the open source version of the code editor.
			  If value IsA ObjoScriptFormatter = False Then
			    Raise New InvalidArgumentException("The demo version of XUICodeEditor only permits the use of ObjoScript formatters. " + _
			    "The full version (https://xui.software) supports any language.")
			  End If

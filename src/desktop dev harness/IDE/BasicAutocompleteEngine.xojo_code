#tag Class
Protected Class BasicAutocompleteEngine
	#tag Method, Flags = &h0, Description = 4164647320616E206F7074696F6E20776974682074686520737065636966696564206076616C75656020616E64206F7074696F6E616C20617262697472617279206064617461602E
		Sub AddOption(value As String, data As Variant = Nil)
		  /// Adds an option with the specified `value` and optional arbitrary `data`.
		  /// 
		  /// Raises an `InvalidArgumentException` if the engine already contains a matching value.
		  
		  If value = "" Then 
		    Raise New InvalidArgumentException("Cannot add option to the autocomplete engine as `value` is empty.")
		  End If
		  ...
		  mOptions.Add(New XUICEAutocompleteOption(value, data))
	...
	#tag Method, Flags = &h0, Description = 52657475726E73206175746F636F6D706C657465206461746120666F722074686520676976656E207072656669782E
		Function DataForPrefix(prefix As String) As XUICEAutocompleteData
		  /// Returns autocomplete data for the given prefix.
		  
		  Var data As New XUICEAutocompleteData
		  data.Prefix = prefix
	...
	#tag Method, Flags = &h0, Description = 52657475726E7320616E206172726179206F6620616C6C206175746F636F6D706C657465206F7074696F6E73206B6E6F776E20746F2074686520656E67696E652C20736F7274656420616C7068616265746963616C6C792E
		Function Options() As XUICEAutocompleteOption()
		  ...
		  ///
		  /// We return a new array with cloned objects so they can be modified without fear of messing up the engine.
		  
		  Var opts() As XUICEAutocompleteOption
	...
	#tag Method, Flags = &h21, Description = 44656C6567617465206D6574686F6420666F7220736F7274696E6720616E206172726179206F66206175746F636F6D706C657465206F7074696F6E7320696E20617363656E64696E6720616C7068616265746963616C206F726465722E
		Private Function OptionsSortDelegate(option1 As XUICEAutocompleteOption, option2 As XUICEAutocompleteOption) As Integer
	...
	#tag Property, Flags = &h21, Description = 416E206172726179206F66206B6E6F776E206175746F636F6D706C657465206F7074696F6E732E
		Private mOptions() As XUICEAutocompleteOption
	#tag EndProperty

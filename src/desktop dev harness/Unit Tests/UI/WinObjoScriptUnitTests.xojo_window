#tag DesktopWindow
Begin DesktopWindow WinObjoScriptUnitTests
   Backdrop        =   0
...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub RunTests()
		  ...
		  'Var groups() As TestGroup = Controller.TestGroups
		  For Each group As TestGroup In Controller.TestGroups
		    group.StopTestOnFail = RunUntilFail
		  Next group

...
Protected Module KeyValue
	...
	#tag Method, Flags = &h1, Description = 52657475726E73206120737472696E6720726570726573656E746174696F6E206F662061204B657956616C756520696E7374616E63652E
		Protected Function AsString(kv As ObjoScript.Instance) As String
		  ...
		  Return ObjoScript.VM.StackValueToString(data.Left) + " : " + ObjoScript.VM.StackValueToString(data.Right)
	...
	#tag Method, Flags = &h1, Description = 52657475726E7320746865206B65792E
		Protected Sub GetKey(vm As ObjoScript.VM)
		  ...
		  Core.SetReturn(vm, Pair(ObjoScript.Instance(vm.GetSlotValue(0)).ForeignData).Left)
	...
	#tag Method, Flags = &h1, Description = 52657475726E73207468652076616C75652E
		Protected Sub GetValue(vm As ObjoScript.VM)
		  ...
		  Core.SetReturn(vm, Pair(ObjoScript.Instance(vm.GetSlotValue(0)).ForeignData).Right)

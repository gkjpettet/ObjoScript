...
Protected Module List
	...
	#tag Method, Flags = &h1, Description = 52657475726E73206120737472696E6720726570726573656E746174696F6E206F662074686520606C6973746020696E2074686520666F726D61743A20225B6974656D312C206974656D4E5D222E
		Protected Function AsString(list As ObjoScript.Instance) As String
		  ...
		  For Each item As Variant In items
		    s.Add(ObjoScript.VM.StackValueToString(item))
		  Next item
	...
	#tag Method, Flags = &h1, Description = 52657475726E7320746865206E657874206974657261746F722076616C75652E
		Protected Sub IteratorValue(vm As ObjoScript.VM)
		  ...
		  Core.SetReturn(vm, ObjoScript.Core.List.ListData(instance.ForeignData).Items(index))
	...
	#tag Method, Flags = &h1, Description = 506F707320746865206869676865737420696E646578206974656D206F666620746865206C69737420616E642072657475726E732069742E204974277320612072756E74696D65206572726F7220696620746865206C69737420697320656D7074792E
		Protected Sub Pop(vm As ObjoScript.VM)
		  ...
		  Else
		    Core.SetReturn(vm, data.Items.Pop)
		  End If
	...
	#tag Method, Flags = &h1, Description = 52657475726E732066616C736520696620746865726520617265206E6F206D6F7265206974656D7320746F2069746572617465206F722072657475726E7320746865206E6578742076616C756520696E207468652073657175656E63652E
		Protected Sub Subscript(vm As ObjoScript.VM)
		  ...
		  If ObjoScript.VariantIsIntegerDouble(arg) Then
		    ...
		    Core.SetReturn(vm, data.Items(index))
		  ...
		  ElseIf arg IsA ObjoScript.Instance And ObjoScript.Instance(arg).Klass.Name.CompareCase("List") Then
		    ...
		    For Each v As Variant In rangeIndices
		      If Not ObjoScript.VariantIsPositiveInteger(v) Then
		        vm.Error("Expected range index to be a positive integer. Instead got `" + vm.StackValueToString(v) + "`.")
		      End If
